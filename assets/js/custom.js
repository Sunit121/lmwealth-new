...
if (scrollToTop) {
    ...
    scrollToTop.addEventListener('click', function (e) {
        ...
        html.style.scrollBehavior = 'auto'; // Disable CSS smooth scroll to prevent lag/conflict

        const duration = 300; // Scroll duration in milliseconds (fast and smooth)
        ...
        function animate(currentTime) {
            ...
            if (progress < 1) {
                ...
                html.style.scrollBehavior = originalScrollBehavior; // Restore original scroll behavior
            }
        }
